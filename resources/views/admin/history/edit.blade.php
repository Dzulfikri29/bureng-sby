                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        <label for="first_gallery_id" class="form-label">{{ Str::headline('gambar 1') }}</label>
                                        <div class="tom-select-custom mb-1">
                                            <select class="form-select" id="first_gallery_id" name="first_gallery_id" required>
                                                @if ($model->first_gallery)
                                                    <option value="{{ $model->first_gallery->id }}">{{ $model->first_gallery->name }}</option>
                                                @endif
                                            </select>
                                        </div>
                                        @error('first_gallery_id')
                                            <span class="form-text text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        <label for="second_gallery_id" class="form-label">{{ Str::headline('gambar 2') }}</label>
                                        <div class="tom-select-custom mb-1">
                                            <select class="form-select" id="second_gallery_id" name="second_gallery_id" required>
                                                @if ($model->second_gallery)
                                                    <option value="{{ $model->first_gallery->id }}">{{ $model->first_gallery->name }}</option>
                                                @endif
                                            </select>
                                        </div>
                                        @error('second_gallery_id')
                                            <span class="form-text text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
