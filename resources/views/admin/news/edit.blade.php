                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="date" class="form-control text-capitalize" name="date" id="date" required value="{{ $model->date }}">
                                        @error('date')
                                            <span class="form-text text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="location" class="form-control text-capitalize" name="location" id="location" required value="{{ $model->location }}">
                                        @error('location')
                                            <span class="form-text text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
