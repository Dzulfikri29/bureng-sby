                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        <label for="title" class="form-label">{{ Str::headline('link youtube') }}</label>
                                        <input type="text" class="form-control text-capitalize" name="youtube_link" id="youtube_link" required value="{{ @old('youtube_link') }}">
                                        @error('youtube_link')
                                            <span class="form-text text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
