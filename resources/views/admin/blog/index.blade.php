        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                ...
                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                    ...
                    <!-- Dropdown -->
                    <div class="dropdown">
                        <button type="button" class="btn btn-white btn-sm dropdown-toggle w-100" id="blogsExportDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi-download me-2"></i> Export
                        </button>

                        <div class="dropdown-menu dropdown-menu-sm-end" aria-labelledby="blogsExportDropdown">
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable-blog" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
