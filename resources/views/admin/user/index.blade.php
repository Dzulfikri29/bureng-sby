    ...
    <div class="content container-fluid">
        ...
        <div class="card">
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable-user" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
...
@section('javascript')
    <script src="{{ asset('admin-assets/js/user/user.js') }}"></script>
    <script>
