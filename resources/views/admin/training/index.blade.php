        ...
        <div class="card">
            ...
            <div class="card-header card-header-content-md-between">
                ...
                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                    ...
                    <!-- Dropdown -->
                    <div class="dropdown">
                        <button type="button" class="btn btn-white btn-sm dropdown-toggle w-100" id="trainingsExportDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi-download me-2"></i> Export
                        </button>

                        <div class="dropdown-menu dropdown-menu-sm-end" aria-labelledby="trainingsExportDropdown">
            ...
            <div class="table-responsive datatable-custom">
                <table id="datatable-training" class="table table-lg table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th>{{ Str::headline('peserta') }}</th>
                            <th>{{ Str::headline('pelatihan') }}</th>
...
@section('javascript')
    <script src="{{ asset('admin-assets/js/training/training.js') }}"></script>
    <script>
