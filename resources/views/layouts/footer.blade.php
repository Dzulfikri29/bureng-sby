                 ...
                 <div class="row">
                     <div class="col-md-12 col-sm-12 col-lg-3">
                         <div class="widget w-100">
                             ...
                             <p class="mb-0">Lorem ipsum dolor sit amet, coteudtu sicing elit, sed do eiusmod
                                 tempor inc dntut labore et adipi.</p>
                         </div>
                     </div>
                                     ...
                                     <div class="col-md-6 col-sm-6 col-lg-6">
                                         <div class="widget w-100">
                                             ...
                                             <ul class="mb-0 list-unstyled w-100">
                                                 <li><a href="online-courses.html" title="">Online Courses</a>
                                                 </li>
                                                 <li><a href="audio-listening.html" title="">Audio Listening</a>
                                                 </li>
                                     ...
                                     <div class="col-md-6 col-sm-6 col-lg-6">
                                         <div class="widget w-100">
                                             <ul class="mb-0 list-unstyled w-100">
                                                 ...
                                                 <li><a href="urgent-donation.html" title="">Urgent Donation</a>
                                                 </li>
