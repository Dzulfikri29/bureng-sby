$(document).on('ready', function () {
    ...
    // =======================================================
    HSCore.components.HSDatatables.init($('#datatable-training'), {
        ajax: {
...
$("#datatable-training").css("width", "100%");


const toggle_switch = (id) => {
    $.ajax({
        url: `${base_url}/admin/training/${id}/toggle`,
        method: "POST",
        headers: {
            'X-CSRF-TOKEN': token,
        },
        success: function (res) {
            ...
            $('#toggle_switch_' + id).prop('checked', res.data.status == "approve" ? true : false);
        }
    });
}
