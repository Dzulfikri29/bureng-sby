new TomSelect('#first_gallery_id', {
    valueField: 'id',
    labelField: 'name',
    searchField: 'name',
    createOnBlur: true,
...
new TomSelect('#second_gallery_id', {
    valueField: 'id',
    labelField: 'name',
    searchField: 'name',
    createOnBlur: true,
...
Dropzone.options.historyImageUpload = {
    paramName: 'image',
    textTarget: null,
    maxFileSize: 1024,
...
const get_history_images = () => {
    $('#fancyboxGallery').html('');
    $.ajax({
        url: `${base_url}/admin/history-image`,
        method: "GET",
        headers: {
            'X-CSRF-TOKEN': token,
        },
                                ...
                                <div class="card card-sm">
                                    ...
                                    <div class="card-body">
                                        <div class="row col-divider text-center">
                                            ...
                                            <div class="col">
                                                <a class="text-danger" href="javascript:;" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Delete" data-bs-original-title="Delete" onclick="delete_history_image('${e.image}')">
                                                    <i class="bi-trash"></i>
                                                </a>
                                            </div>
                                        </div>
...
const delete_history_image = (name) => {
    $.ajax({
        url: `${base_url}/admin/history-image-delete`,
        method: "POST",
        headers: {
            'X-CSRF-TOKEN': token,
        },
