new TomSelect('#product_category_id', {
    ...
    load: function (query, callback) {
        var url = `${base_url}/product-category/select`;
        fetch(url, {
                method: 'POST',
                headers: {
...
const get_product_images = () => {
    ...
    $.ajax({
        url: `${base_url}/admin/product-image`,
        method: "GET",
        headers: {
            'X-CSRF-TOKEN': token,
        },
                                ...
                                <div class="card card-sm">
                                    ...
                                    <div class="card-body">
                                        <div class="row col-divider text-center">
                                            ...
                                            <div class="col">
                                                <a class="text-danger" href="javascript:;" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Delete" data-bs-original-title="Delete" onclick="delete_product_image('${e.image}')">
                                                    <i class="bi-trash"></i>
                                                </a>
                                            </div>
                                        </div>
...
const delete_product_image = (name) => {
    $.ajax({
