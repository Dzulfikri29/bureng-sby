...
Dropzone.options.newsImageUpload = {
    paramName: 'image',
    textTarget: null,
    maxFileSize: 1024,
...
const get_news_images = () => {
    $('#fancyboxGallery').html('');
    $.ajax({
        url: `${base_url}/admin/news-image`,
        method: "GET",
        headers: {
            'X-CSRF-TOKEN': token,
        },
                                ...
                                <div class="card card-sm">
                                    ...
                                    <div class="card-body">
                                        <div class="row col-divider text-center">
                                            ...
                                            <div class="col">
                                                <a class="text-danger" href="javascript:;" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Delete" data-bs-original-title="Delete" onclick="delete_news_image('${e.image}')">
                                                    <i class="bi-trash"></i>
                                                </a>
                                            </div>
                                        </div>
...
const delete_news_image = (name) => {
    $.ajax({
        url: `${base_url}/admin/news-image-delete`,
        method: "POST",
        headers: {
            'X-CSRF-TOKEN': token,
        },
