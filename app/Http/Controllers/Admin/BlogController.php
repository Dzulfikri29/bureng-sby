...
class BlogController extends Controller
{
            ...
            return DataTables::of($data)
                ->addColumn('checkbox', function ($row) {
                    $checkbox = "<div class='form-check'>
                                    <input type='checkbox' class='form-check-input' id='blogsDataCheck$row->id' name='multi_delete_$this->view_folder[]' value='$row->id'>
                                    <label class='form-check-label' for='blogsDataCheck$row->id'></label>
                                </div>";
    ...
    public function store(Request $request)
    {
        ...
        $find_same_slug = Blog::where('slug', $slug)->first();

        if ($find_same_slug) {
            return redirect()->back()->withInput()->withErrors(['title' => 'Nama blog telah digunakan']);
        }
        ...
        try {
            ...
            if (!$blog_category) {
                ...
                $blog_category->name = $request->blog_category_id;
                $blog_category->save();
            }

            $model = new model();
            $model->blog_category_id = $blog_category->id;
            $model->slug = $slug;
            ...
            $response = ['success' => true, 'message' => 'blog created successfully'];
            DB::commit();
    ...
    public function update(Request $request, $id)
    {
        ...
        $slug = Str::slug(Str::lower($request->title));
        $find_same_slug = Blog::where('slug', $slug)
            ->where('id', '!=', $id)
            ->first();
    ...
    public function toggle(Request $request, $id)
    {
        ...
        try {
            ...
            $response = ['success' => true, 'message' => 'Blog status updated successfully'];
            DB::commit();
    ...
    public function upload_image(Request $request)
    {
        ...
        try {
            if ($request->file('image')) {
                ...
                Storage::put('blog/' . $file_name, (string) $image->encode());
                $image_path = 'blog/' . $file_name;
            }
